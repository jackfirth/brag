...
@(my-eval '(require yaragg/examples/nested-word-list 
                    racket/list
                    racket/match))
...
@itemize[
 @item{Tell Racket to use the @tt{brag}-generated parser and lexer we defined
  ...
  @litchar{#lang yaragg/examples/simple-line-drawing}.}
...
@filepath{yaragg/examples/simple-line-drawing/lang/reader.rkt}:

@filebox["yaragg/examples/simple-line-drawing/lang/reader.rkt"]{
 @codeblock|{
...
compilation:
@filebox["yaragg/examples/simple-line-drawing/semantics.rkt"]{
 @codeblock|{
  #lang racket/base
...
@defmodule[yaragg/support]

The @racketmodname[yaragg/support] module provides functions to interact with
